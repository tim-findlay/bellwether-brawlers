...
export default {
  ...
  s1: { name: 'Calendar Block', kind: 'parry', air: true, stance: 20, recover: 25, cooldown: 300, counter: { dmg: 12, kb: 7, kbScale: 6, kbAngle: 50, meter: 10, name: 'Declined', callout: 'DECLINED!', applyStatus: { name: 'silence', dur: 90 } } },
  s2: { name: 'House Rosé', kind: 'lob', air: true, dmg: 7, kb: 5, kbScale: 4, kbAngle: 45, speed: 3.4, vy: -6.4, grav: 0.32, w: 16, h: 16, shape: 'glass', color: '#b04a6e', cooldown: 280, applyStatus: { name: 'slow', dur: 120 }, startup: 12, active: 2, recover: 16 },
