...
export default {
  ...
  stats: { gauge: 90, runMax: 5.6, jumpImpulse: 15.5, fallMax: 13, weight: 0.9 },
  light: { name: 'Reschedule', dmg: 4, kb: 4.5, kbScale: 5, kbAngle: 40, range: 56, startup: 4, active: 3, recover: 10 },
  heavy: { name: 'Double-Booked', dmg: 9, kb: 6.5, kbScale: 11, kbAngle: 35, range: 62, startup: 8, active: 3, recover: 19 },
  aerials: aerials({ n: 'Wristband Whirl', s: 'Tote Swing', u: 'Confetti Pop', d: 'Baggage Drop' }, { n: { range: 70, dmg: 6 }, d: { dmg: 8, kbScale: 10 } }),
