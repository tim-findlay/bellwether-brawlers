...
export default {
  ...
  s1: { name: 'Calendar Block', kind: 'parry', stance: 20, recover: 25, cooldown: 300, counter: { dmg: 12, kb: 7, kbScale: 6, kbAngle: 50, meter: 10, name: 'Declined', callout: 'DECLINED!', applyStatus: { name: 'silence', dur: 90 } } },
