...
export default {
  ...
  stats: { gauge: 86, runMax: 5.8, jumpImpulse: 15.5, fallMax: 13.5, weight: 0.95 },
  light: { name: 'Toothbrush Jab', dmg: 4, kb: 4.5, kbScale: 4, kbAngle: 40, range: 56, startup: 3, active: 3, recover: 14 },
  heavy: { name: 'Pivot Table', dmg: 9, kb: 7, kbScale: 11, kbAngle: 40, range: 64, startup: 10, active: 4, recover: 16, bothSides: true },
  aerials: aerials({ n: 'Panic Flail', s: 'Overreach', u: 'Up-and-Over', d: 'Faceplant' }, { n: { range: 72 }, d: { whiffStagger: true } }),
  s1: { name: 'Clumsy Charge', kind: 'lunge', air: true, dmg: 11, kb: 7, kbScale: 9, kbAngle: 35, travel: 170, range: 50, startup: 8, active: 8, recover: 18, cooldown: 380, whiffTrip: true },
