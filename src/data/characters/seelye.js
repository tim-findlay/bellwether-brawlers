...
export default {
  ...
  stats: { gauge: 110, runMax: 5.0, jumpImpulse: 14.5, fallMax: 15, weight: 1.15 },
  light: { name: 'Term Sheet', dmg: 6, kb: 5, kbScale: 5, kbAngle: 40, range: 60, startup: 5, active: 3, recover: 8 },
  heavy: { name: 'Leverage', dmg: 13, kb: 7, kbScale: 12, kbAngle: 35, range: 66, startup: 12, active: 4, recover: 15, applyStatus: { name: 'lien', dur: 480 } },
