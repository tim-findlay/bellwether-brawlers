...
export default {
  ...
  s1: { name: 'Prompt Injection', kind: 'projectile', air: true, dmg: 7, kb: 5, kbScale: 4, kbAngle: 40, speed: 3.2, w: 24, h: 18, shape: 'email', color: '#ddd5c2', cooldown: 280, applyStatus: { name: 'reversed', dur: 72 }, startup: 12, active: 2, recover: 16 },
