...
export default {
  ...
  tip: 'No recovery special — his jumps are honest. Edge-guard him hard, and step off the marker when he schedules a send.',
  ...
  super: { name: 'Run Flow', kind: 'dashCombo', dmg: 22, kb: 9, kbScale: 15, kbAngle: 40, range: 50, travel: 200, startup: 12, active: 6, recover: 30, iframes: 12, aiRange: [80, 280] },
