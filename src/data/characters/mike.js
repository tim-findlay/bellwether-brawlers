...
export default {
  ...
  stats: { gauge: 102, runMax: 4.4, jumpImpulse: 14, fallMax: 16, weight: 1.12 },
  ...
  s1: { name: 'Scaffold Slam', kind: 'grab', aimable: true, dmg: 14, kb: 8, kbScale: 11, kbAngle: 45, range: 68, startup: 16, recover: 24, cooldown: 380, unparryable: true },
