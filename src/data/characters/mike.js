...
export default {
  ...
  stats: { gauge: 102, runMax: 4.4, jumpImpulse: 14, fallMax: 16, weight: 1.08 },
  light: { name: 'Hard Hat', dmg: 5, kb: 5, kbScale: 6, kbAngle: 40, range: 60, startup: 6, active: 3, recover: 12 },
  heavy: { name: 'Wrecking Swing', dmg: 10, kb: 7, kbScale: 11.5, kbAngle: 35, range: 72, startup: 14, active: 4, recover: 26, armor: [7, 13] },
