...
export default {
  ...
  stats: { gauge: 110, runMax: 4.8, jumpImpulse: 14.5, fallMax: 15, weight: 1.25 },
  light: { name: 'Pistachio Flick', dmg: 5, kb: 5, kbScale: 5, kbAngle: 40, range: 74, startup: 5, active: 3, recover: 10 },
  heavy: { name: 'Wingspan', dmg: 12, kb: 8, kbScale: 14, kbAngle: 35, range: 92, startup: 16, active: 4, recover: 20 },
  aerials: aerials({ n: 'Air Clearance', s: 'Long Reach', u: 'Pistachio Pop', d: 'L-Plate Drop' }, { s: { range: 90, kb: 7, kbScale: 12, startup: 9 } }),
  s1: { name: 'Hawk Toss', kind: 'lob', air: true, dmg: 9, kb: 6, kbScale: 8, kbAngle: 45, speed: 4.4, vy: -6, grav: 0.28, w: 20, h: 14, shape: 'football', color: '#8b5e34', cooldown: 300, startup: 13, active: 2, recover: 18 },
