...
export default {
  ...
  stats: { gauge: 85, runMax: 6.2, jumpImpulse: 16, fallMax: 12, weight: 0.9 },
  light: { name: 'Name Drop', dmg: 5, kb: 4.5, kbScale: 5, kbAngle: 40, range: 56, startup: 3, active: 2, recover: 6 },
  heavy: { name: 'Fund Structure', dmg: 10, kb: 6, kbScale: 10, kbAngle: 35, range: 64, startup: 12, active: 3, recover: 16 },
