...
export default {
  ...
  stats: { gauge: 85, runMax: 6.2, jumpImpulse: 16, fallMax: 12, weight: 0.85 },
  light: { name: 'Name Drop', dmg: 5, kb: 4.5, kbScale: 5, kbAngle: 40, range: 56, startup: 3, active: 2, recover: 6 },
  heavy: { name: 'Fund Structure', dmg: 10, kb: 6.5, kbScale: 12, kbAngle: 35, range: 64, startup: 9, active: 3, recover: 15 },
  aerials: aerials({ n: 'Velvet Rope', s: 'Card Fan', u: 'Upgrade', d: 'Check-Out' }, { s: { startup: 6, kb: 5.5, kbScale: 10 } }),
  s1: { name: 'Status Match', kind: 'teleport', air: true, behind: 56, startup: 12, recover: 14, iframes: 18, cooldown: 270 },
  s2: { name: 'Points Redemption', kind: 'fan', dmg: 4, kb: 4, kbScale: 5, kbAngle: 40, speed: 5.4, w: 16, h: 12, shape: 'card', color: '#b9a16b', cooldown: 260, startup: 10, active: 2, recover: 16 },
