...
export const CHARACTERS = [
  {
    ...
    s1: { name: 'Hawk Toss', kind: 'lob', dmg: 9, kb: 2.5, speed: 2.2, vy: -3.0, grav: 0.14, w: 10, h: 7, shape: 'football', color: '#8b5e34', cooldown: 300 },
  ...
  },
  {
    ...
    light: { name: 'Quick Sync', dmg: 4, kb: 1.5, range: 30, startup: 4, active: 3, recover: 9 },
    heavy: { name: 'Hard Deadline', dmg: 10, kb: 3, range: 35, startup: 11, active: 4, recover: 17 },
    s1: { name: 'Prompt Injection', kind: 'projectile', dmg: 7, kb: 2, speed: 1.5, w: 12, h: 9, shape: 'email', color: '#ddd5c2', cooldown: 280, applyStatus: { name: 'reversed', dur: 72 } },
  ...
  },
  {
    ...
    stats: { hp: 92, speed: 1.68, jump: 5.9, weight: 0.95 },
    light: { name: 'Toothbrush Jab', dmg: 4, kb: 1.4, range: 28, startup: 3, active: 3, recover: 8 },
    heavy: { name: 'Pivot Table', dmg: 9, kb: 2.8, range: 32, startup: 10, active: 4, recover: 16 },
    s1: { name: 'Clumsy Charge', kind: 'lunge', dmg: 11, kb: 3.2, travel: 75, range: 24, startup: 8, active: 8, recover: 18, cooldown: 300, whiffTrip: true },
    s2: { name: 'Coffee Spill', kind: 'zone', startup: 12, recover: 16, cooldown: 380, zone: { type: 'coffee', w: 46, life: 360, ahead: 55, ownerImmune: true } },
  ...
  },
  {
    ...
    light: { name: 'Bid', dmg: 4, kb: 1.5, range: 30, startup: 4, active: 3, recover: 9 },
    heavy: { name: 'Short Squeeze', dmg: 10, kb: -2.2, range: 34, startup: 11, active: 4, recover: 17 },
    s1: { name: 'Bull Run', kind: 'projectile', dmg: 8, kb: 2.5, launcher: true, speed: 2.4, vy: -0.55, w: 9, h: 26, height: 30, shape: 'candle', color: '#3f5a40', cooldown: 240, sharedLock: 45, tag: 'bull' },
    s2: { name: 'Bear Raid', kind: 'groundProjectile', dmg: 7, kb: 2.5, launcher: true, speed: 2.0, w: 9, h: 14, shape: 'candle', color: '#c4452e', cooldown: 260, sharedLock: 45, tag: 'bear' },
  ...
  },
  {
    ...
    light: { name: 'Name Drop', dmg: 4, kb: 1.4, range: 28, startup: 3, active: 2, recover: 7 },
    heavy: { name: 'Fund Structure', dmg: 9, kb: 2.8, range: 32, startup: 9, active: 3, recover: 15 },
    s1: { name: 'Status Match', kind: 'teleport', behind: 26, startup: 12, recover: 14, iframes: 18, cooldown: 320 },
    s2: { name: 'Points Redemption', kind: 'fan', dmg: 3, kb: 1.2, speed: 2.6, w: 8, h: 6, shape: 'card', color: '#b9a16b', cooldown: 300, chipOnce: true },
  ...
  },
  {
    ...
    light: { name: 'Reschedule', dmg: 4, kb: 1.4, range: 28, startup: 4, active: 3, recover: 8 },
    heavy: { name: 'Double-Booked', dmg: 9, kb: 2.6, range: 31, startup: 8, active: 3, recover: 14 },
    s1: { name: 'Calendar Block', kind: 'parry', stance: 20, recover: 25, cooldown: 300 },
    s2: { name: 'House Rosé', kind: 'lob', dmg: 7, kb: 2, speed: 1.7, vy: -3.2, grav: 0.16, w: 8, h: 8, shape: 'glass', color: '#b04a6e', cooldown: 280, applyStatus: { name: 'slow', dur: 120 } },
  ...
  },
  {
    ...
    stats: { hp: 125, speed: 1.2, jump: 5.1, weight: 1.45 },
    light: { name: 'Hard Hat', dmg: 6, kb: 1.8, range: 30, startup: 6, active: 3, recover: 12 },
    heavy: { name: 'Wrecking Swing', dmg: 13, kb: 3.6, range: 36, startup: 14, active: 4, recover: 20, armor: [4, 18] },
    s1: { name: 'Scaffold Slam', kind: 'grab', dmg: 14, range: 30, startup: 16, recover: 24, cooldown: 380, unblockable: true },
    s2: { name: 'Demolition Day', kind: 'shockwave', dmg: 10, kb: 3.5, radius: 70, startup: 18, recover: 24, cooldown: 360 },
  ...
  },
  {
    ...
    stats: { hp: 104, speed: 1.34, jump: 5.3, weight: 1.15 },
    light: { name: 'Term Sheet', dmg: 5, kb: 1.6, range: 30, startup: 5, active: 3, recover: 10 },
    heavy: { name: 'Leverage', dmg: 11, kb: 3, range: 33, startup: 12, active: 4, recover: 18, applyStatus: { name: 'lien', dur: 480 } },
    s1: { name: 'Brisket Bomb', kind: 'lob', dmg: 6, kb: 2, speed: 1.5, vy: -3.4, grav: 0.17, w: 10, h: 8, shape: 'bomb', color: '#6b4226', cooldown: 320, zoneOnLand: { type: 'ember', w: 50, life: 180, ownerImmune: true } },
    s2: { name: 'Dad Reflexes', kind: 'catch', stance: 30, recover: 20, cooldown: 240 },
    super: { name: 'Low & Slow', kind: 'zoneSuper', dur: 300, startup: 18, recover: 22, aiRange: [0, 480] },
