...
110 / 5.0 / 1.05 — **a regular businessman in a forest-green Peter Millar-style quarter-zip over a white button-down, charcoal trousers, no tie** (Tim's notes: not a BBQ guy; green pullover). The BBQ kit — Brisket Bomb, Dad Reflexes, LOW & SLOW — stays for now; the smoke is his hobby, not his outfit.
